...
\textit{Blockchain and Digital Twin integration} is the most frequently identified gap, mentioned in five articles. The literature consistently notes that AI-based risk management systems would benefit substantially from integration with blockchain for immutable audit trails and Digital Twin environments for real-time simulation of disruption scenarios~\cite{fernando2024covid, nguyen2024federated, yang2024building}. The absence of empirical studies implementing such integrations at operational scale represents the most prominent frontier for future research.
 
\textit{Lack of real-time data and IoT integration} is cited in four articles as a barrier to the operationalisation of AI risk management frameworks. Many proposed models are validated on historical batch datasets rather than live operational streams, limiting their applicability for real-time early warning~\cite{deivaganesh2022supply, yang2025design}. Future research should prioritise architectures that ingest IoT sensor data, RFID streams, and other real-time supply chain telemetry.
